...
urlpatterns = [
    ...
    path('token/<str:transport_name>/<int:messenger_id>', api_views.VPNToken.as_view(), name='get_client_tokens'),
    ...
    path('token/renew/<int:token_id>', api_views.VPNToken.as_view(), name='renew_exist_token'),
    path('token/demo/', api_views.VPNTokenDemo.as_view(), name='create_demo_token'),
    path('token/new/', api_views.VPNToken.as_view(), name='create_new_token'),
