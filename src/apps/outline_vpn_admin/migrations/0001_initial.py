    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('uid_format', models.CharField(blank=False, max_length=254, verbose_name='Формат уникального идентификатора бота', help_text='Наименование уникального идентификатора в credentials. {поле_уникального_идентификатора}')),
                ('full_name_format', models.CharField(max_length=254, null=True, verbose_name='Формат имени клиента', default='', help_text='Наименование полей в credentials для формирования имени клиента. {Поле_1} {Поле_2} и т.д.')),
