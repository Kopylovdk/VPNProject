...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('telegram_user_record', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='outline_vpn_admin.TelegramUsers', verbose_name='Владелец ключа', null=True, blank=True)),
