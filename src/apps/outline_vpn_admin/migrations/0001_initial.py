...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('uid', models.CharField(help_text='UID контакта. Присваивается при сохранении в формате: <Transport.name>@<Transport.uid_format>', max_length=254, unique=True, verbose_name='Идентификатор контакта')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=3, unique=True, verbose_name='Буквенный код валюты по ISO 4217')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=254, unique=True, verbose_name='Имя тарифа')),
                ('prolong_period', models.IntegerField(blank=True, null=True, verbose_name='Срок продления в днях')),
                ('price', models.DecimalField(decimal_places=2, max_digits=10, verbose_name='Стоимость')),
                ('traffic_limit', models.IntegerField(blank=True, null=True, verbose_name='Ограничение трафика в байтах')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=254, unique=True, verbose_name='Название бота')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=254, unique=True, verbose_name='Внутреннее имя VPN сервера')),
                ('external_name', models.CharField(max_length=254, unique=True, verbose_name='Внешнее имя VPN сервера')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_demo', models.BooleanField(default=False, verbose_name='Демо ключ')),
                ('is_tech', models.BooleanField(default=False, verbose_name='Технический ключ')),
                ('traffic_limit', models.BigIntegerField(blank=True, null=True, verbose_name='Лимит трафика')),
                ('created_at', models.DateField(auto_now_add=True, verbose_name='Дата создания записи')),
                ('updated_at', models.DateField(auto_now=True, verbose_name='Дата обновления записи')),
                ('client', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='outline_vpn_admin.client', verbose_name='Владелец ключа')),
        ...
        migrations.AddField(
            model_name='contact',
            name='transport',
            field=models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='outline_vpn_admin.transport', verbose_name='Канал связи'),
        ),
    ]
